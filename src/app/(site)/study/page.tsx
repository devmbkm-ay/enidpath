...
export default async function Study() {
  ...
  const pageData = {
    ...
    studyBenefits:
      pageContent?.studyBenefits?.length ? pageContent.studyBenefits : defaultBenefits,
  };
        ...
        <div className="container">
          <div className="max-w-4xl">
            ...
            <div className="space-y-4 text-muted-foreground leading-relaxed">
              {pageData.aboutParagraphs.map((paragraph: any, index: number) => (
        ...
        <div className="container">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <p className="text-muted-foreground text-lg">
              {pageData.programmesSectionSubtitle}
            </p>
          </div>
      ...
      <section className="py-20 bg-background">
        <div className="container">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <p className="text-muted-foreground text-lg">
              {pageData.benefitsSectionSubtitle}
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {pageData.studyBenefits.map((benefit: any, index: number) => {

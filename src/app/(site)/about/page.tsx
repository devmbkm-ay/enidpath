  ...
  const pageData = {
    ...
    overviewParagraphs:
      pageContent?.overviewParagraphs?.length
        ...
        : defaultContent.overviewParagraphs,
    coreValues: pageContent?.coreValues?.length ? pageContent.coreValues : defaultCoreValues,
  };
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                {pageData.overviewParagraphs.map((paragraph: any, index: number) => (
            ...
            <div className="bg-muted rounded-lg p-8">
              <div className="space-y-8">
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="font-display font-semibold text-lg text-foreground mb-2">{pageData.missionTitle}</h3>
                    <p className="text-muted-foreground">
                      {pageData.missionBody}
                    </p>
                  </div>
                </div>
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="font-display font-semibold text-lg text-foreground mb-2">{pageData.visionTitle}</h3>
                    <p className="text-muted-foreground">
                      {pageData.visionBody}
                    </p>
                  </div>
      ...
      <section className="py-20 bg-muted">
        <div className="container">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {pageData.coreValues.map((value: any, index: number) => {
